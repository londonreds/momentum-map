...
var Event = (function($) { return function(properties) {
      ...
      this.render_group = function(distance, zipcode) {
        ...
        if (that.props.url !== '') { social_html += `<a href='${that.props.url}' target='_blank'><img src='/img/icon/globe.png' /></a>`; }
        ...
        if (that.props.social) {
          ...
          if (that.props.social.email !== '') { social_html += `<a target='_top' href='mailto:${that.props.social.email}' ><img src='/img/icon/mailchimp.png' /></a>`; }
